...
@TeleOp(name = "Skystone Detection Test", group = "Test")
//@Disabled //---  Uncomment to disable this teleop mode
public class Skystone_SkystoneDetection extends OpMode {
    ...
    public void init_loop() {
        try {
            telemetry.addData("pos", new SkyStoneFinder().getStonePos());
        } catch(Exception e) {
